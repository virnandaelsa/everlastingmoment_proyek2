    ...
    <div class="form-container">
        ...
        <form action="{{ route('catalog.update', $catalog['id_katalog']) }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="judul-jasa" name="judul_jasa" required placeholder="Judul jasa" value="{{ $catalog['judul'] }}">
            </div>
            <div class="form-group">
                <label for="deskripsi-jasa">Deskripsi jasa</label>
                <input type="text" class="form-control" id="deskripsi_jasa" name="deskripsi_jasa" required placeholder="Deskripsi jasa" value="{{ $catalog['deskripsi'] }}">
            </div>
            {{-- <div class="form-group">
            ...
            <div id="service-details-container">
                <div class="service-detail-group">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="judul-jasa-tawaran" name="judul_jasa_tawaran" placeholder="Judul Jasa" value="{{ $detail_katalog[0]['judul_variasi'] }}">
                    </div>
                    <div class="form-group">
                        <label for="biaya">Harga</label>
                        <input type="text" class="form-control" id="biaya" name="biaya" placeholder="Harga" value="{{ $detail_katalog[0]['harga'] }}">
                    </div>
                    <div class="form-group">
